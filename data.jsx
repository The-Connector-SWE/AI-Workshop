...
const PLATFORMS = {
  ...
  elevenlabs: {
    ...
    about: "The leader in voice AI — v3 Alpha delivers emotionally aware voiceovers, while the Dubbing tool localizes video into 30+ languages in your exact voice. Eleven Music & SFX generates stems and sound effects from text, with lip-sync integrations for talking-head video.",
    usage: [
      "Generate expressive voiceovers with v3 Alpha",
      "Dub videos into 30+ languages in your voice",
      "Design custom voices for characters or narration",
  ...
  artlist: {
    id: "artlist", name: "Artlist", vendor: "AI Video Suite", hue: "#7affb0", url: "https://artlist.io",
    tagline: "Multi-model video production",
    about: "An all-in-one AI film production suite that aggregates Google Veo, OpenAI Sora, and Kling — with Artlist Studio for consistent character casting, Artboards for mood-board-to-final-cut workflows, and a stock legacy of 30,000+ music tracks, 70,000+ SFX, and 8K footage.",
    usage: [
      "Generate AI video with Artlist Studio",
      "Maintain character consistency across scenes",
      "Source licensed music, SFX & 8K footage",
      "Use Artboards to build a unified mood board",
    ],
  },
  magnifica: {
    id: "magnifica", name: "Magnific", vendor: "Pocket AI Design Studio", hue: "#6ec8ff", url: "https://magnific.com/app",
    tagline: "Multi-model creation & upscaling",
    about: "A cross-device AI creation suite built around Freepik's ecosystem. Access image generators (Flux, Ideogram, GPT Image, Imagen, Seedream) and video generators (Seedance, Veo, Kling, Runway Gen, PixVerse) in one workspace — plus AI editing, upscaling, and a native library of 250M+ licensed assets.",
    usage: [
      "Generate images and video from text prompts",
      "Upscale and enhance assets to campaign quality",
      "Edit images with text commands and background removal",
      "Browse 250M+ licensed photos, vectors, and PSD files",
    ],
  },
  arcana: {
